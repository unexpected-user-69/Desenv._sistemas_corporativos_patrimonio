...
async function bootstrap() {
  ...
  console.log(`   - Patrimonio Service: http://localhost:3003`);
  console.log(`   - Categorias Service: http://localhost:3004`);
  console.log(`   - Audit Service:      http://localhost:3005`);
  console.log(`   - Events Service:     http://localhost:3006\n`);
}
