...
// User e Patrimonio - referências removidas por enquanto
// No futuro, quando Users Service e Patrimonio Service forem criados, usar HTTP clients
...
export class Event {
  ...
  // Relação com User removida - usar apenas createdBy (UUID)
  // No futuro, quando Users Service for criado, buscar via HTTP client
