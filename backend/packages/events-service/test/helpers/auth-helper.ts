/**
 * Helper para autenticação em testes E2E do Events Service
 * 
 * Este módulo fornece funções para gerar tokens JWT válidos para testes,
 * já que o events-service valida tokens localmente usando JWT_ACCESS_SECRET.
 */
 ...
 * 
 * Nota: Para testes e2e do events-service, criamos usuários no banco
 * e geramos tokens JWT diretamente, já que o serviço valida tokens localmente.
 */
export async function setupTestUsers(
  ...
  // Gerar tokens JWT
  // Os roles devem corresponder aos valores do enum UserRole (ADMIN, MANAGER, OPERATOR)
...
export function getTokenForRole(
  ...
  // Se ADMIN está nas roles necessárias, usar ADMIN
