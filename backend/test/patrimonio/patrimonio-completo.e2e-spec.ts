...
function getFotoTestPath(filename: string): string {
  // Para CI, criar arquivos temporários se não existirem
  ...
  // Criar arquivo dummy se não existir (para CI)
  if (!fs.existsSync(tempFilePath)) {
    // Criar um arquivo PNG dummy simples (1x1 pixel transparente)
...
describe('Patrimonio - Completo (e2e)', () => {
  ...
  afterAll(async () => {
    ...
    try {
      ...
      // Ignorar erros de limpeza de arquivos
    }
