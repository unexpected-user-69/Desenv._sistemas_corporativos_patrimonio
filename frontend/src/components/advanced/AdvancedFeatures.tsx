...
export const AdvancedFeatures: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'search' | 'fuzzy' | 'dateRange' | 'stats'>('search');
  ...
  const handleAdvancedSearch = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Erro na busca avançada');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleFuzzySearch = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Erro na busca fuzzy');
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleDateRangeSearch = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Erro na busca por data');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setAdvancedSearch({ ...advancedSearch, query: e.target.value })}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setAdvancedSearch({ 
                    ...advancedSearch, 
                    sort: { ...advancedSearch.sort, order: e.target.value as 'asc' | 'desc' } 
                  })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setAdvancedSearch({ 
                    ...advancedSearch, 
                    pagination: { ...advancedSearch.pagination, limit: parseInt(e.target.value) } 
                  })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  min="1"
                  max="100"
            ...
            <div className="flex items-center space-x-4">
              <label className="flex items-center">
                <input
                  ...
                  onChange={(e) => setAdvancedSearch({ 
                    ...advancedSearch, 
                    options: { ...advancedSearch.options, fuzzy: e.target.checked } 
                  })}
              ...
              <label className="flex items-center">
                <input
                  ...
                  onChange={(e) => setAdvancedSearch({ 
                    ...advancedSearch, 
                    options: { ...advancedSearch.options, highlight: e.target.checked } 
                  })}
                  className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                />
        ...
        {activeTab === 'fuzzy' && (
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-gray-900">Busca Fuzzy (Aproximada)</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFuzzySearch({ ...fuzzySearch, query: e.target.value })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFuzzySearch({ ...fuzzySearch, threshold: parseFloat(e.target.value) })}
                  className="w-full"
                />
                <div className="text-sm text-gray-600 mt-1">
                  {fuzzySearch.threshold} (0 = muito flexível, 1 = muito restritivo)
                </div>
              </div>
            </div>
        ...
        {activeTab === 'dateRange' && (
          <div className="space-y-4">
            <h2 className="text-lg font-semibold text-gray-900">Busca por Intervalo de Datas</h2>
            ...
            {searchResults.data.map((item: any, index: number) => (
              <div key={index} className="px-6 py-4">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-medium text-gray-900">{item.name || item.email}</h3>
                    <p className="text-sm text-gray-600">{item.email || item.role}</p>
                  </div>
